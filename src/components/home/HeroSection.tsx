const HeroSection = () => {
  return (
    <div className="relative overflow-hidden rounded-3xl bg-darkCard/40 backdrop-blur-xl border border-darkBorder/40 p-8 md:p-12 mb-8 shadow-2xl flex flex-col md:flex-row items-center justify-between gap-8">
      ...
      <div className="flex-1 space-y-4 text-left">
        <div className="inline-flex items-center space-x-2 px-3 py-1 rounded-full bg-brandPrimary/10 border border-brandPrimary/30 text-brandPrimary text-xs font-semibold uppercase tracking-wider">
      ...
      <div className="flex-shrink-0 w-full md:w-80 bg-slate-900/50 backdrop-blur-md border border-darkBorder/40 p-6 rounded-2xl shadow-xl space-y-4 hover:translate-y-[-4px] transition-transform duration-300">
        <div className="flex justify-between items-center">
          <span className="text-xs font-semibold text-slate-400">STATUS MONITOR</span>
        ...
        <div className="border-t border-darkBorder/20 pt-4 flex justify-between items-center text-xs">
          ...
          <span className="text-brandPrimary font-medium">CartoDB Dark</span>
        </div>
      </div>
    </div>
  );
